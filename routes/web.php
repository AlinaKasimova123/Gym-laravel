...
Route::get('/userInfo/{id}', [WelcomeController::class, 'index'])->name('welcome')->middleware('auth')->middleware('logs-out-banned-user')->middleware('role:user');
...
Route::get('/', [WelcomeController::class, 'index'])->name('welcome')->middleware('auth')->middleware('role:admin|cityManager|gymManager|coach|user');
#=======================================================================================#
...
Route::controller(AllUsersController::class)->group(function () {
    ...
    Route::get('/allUsers/edit/{id}', 'edit')->name('allUsers.edit')->middleware('auth')->middleware('logs-out-banned-user')->middleware('role:admin|cityManager');
    Route::put('/allUsers/update/{id}', 'update')->name('allUsers.update')->middleware('auth')->middleware('logs-out-banned-user')->middleware('role:admin|cityManager');
});
