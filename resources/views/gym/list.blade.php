                    ...
                    <table class="table table-striped projects" id="proj">
                        <thead>
                            <tr>
                                ...
                                <th class="project-state">Название зала</th>
                                <th class="project-state">Название города</th>
                                <th class="project-state">Создано</th>
                                <th class="project-state">Картинка зала</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($gyms as $gym)
                                <tr id="gid{{ $gym->id }}">
                                    ...
                                    <td class="project-state">
                                        ...
                                        @if ($gym->city == null)
                                            <span class="project-state">У этого зала нет города</span>
                                        @else
