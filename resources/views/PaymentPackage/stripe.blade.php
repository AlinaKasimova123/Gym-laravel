            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row text-center">
                        <h3 class="panel-heading">Детали оплаты</h3>
                    </div>                    
                </div>
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('stripe.post') }}" method="post" class="validation"
                        ...
                        <div class="form-group">
                            <label for="package_id">Зал</label>
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-4 form-group cvc required'>
                                ...
                                <input autocomplete='off' class='form-control card-cvc' placeholder='Например, 415' size='4'
                                    type='text'>
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                <label class='control-label'>Месяц истечения</label> <input
                                    class='form-control card-expiry-month' placeholder='MM' size='2'
                                    type='text'>
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                <label class='control-label'>Год истечения</label> <input
                        ...
                        <div class='form-row row'>
                            <div class='col-md-12 hide error form-group'>
                                <div class='alert-danger alert'>Заполните необходимые поля.</div>
                            </div>
                        </div>
  
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-danger btn-lg btn-block" type="submit">Купить</button>
                            </div>
                        </div>
