            ...
            @endif
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Редактировать менеджера зала</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        @csrf
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="image">Загрузить картинку</label>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <input type="submit" value="Сохранить изменения" class="btn btn-warning float-right">
                </div>
            </div>
        </form>
    </section>
