    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4>Показывать тренировку {{ $trainingSession->id }}</h4>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <table class="table table-striped projects">
                        <thead>
                            <tr>
                                ...
                                <th class="project-state">Наименование</th>
                                <th class="project-state">День</th>
                                <th class="project-state">Начало:</th>
                                <th class="project-state">Окончание:</th>
                            </tr>
                        </thead>
                        <tbody>
