                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select required class=" form-control @error('manager_id') is-invalid @enderror"
                                        ...
                                        @if ($cityData->manager != null)
                                            ...
                                            <option value='optional'>Убрать сити-менеджера</option>
                                        @else
                                            <option value='optional' hidden>Выборочно</option>
                                        @endif
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="submit" value="Обновить" class="btn btn-primary float-right">
                                </div>
                            </div>
                        </div>
                    </div>
