    ...
    public function index()
    {
        ...
        switch ($this->userRole['0']) {
            ...
            case 'coach':
                ...
                break;
            case 'user':
                $userOfGym = User::where('id', $this->userID)->first();
                // return view("userInfo".$userOfGym->packages, [
                //     'trainingSessions' => $userOfGym->packages,
                // ]);
                return view("userInfo", [
                    $userOfGym->id,
                    'singleUser' => $userOfGym,
                    'city' => $userOfGym->city->name,
                    'gym' => $userOfGym->gym->name,
                ]);
                // return view('userInfo.'.$userOfGym->id);
                break;
        }
